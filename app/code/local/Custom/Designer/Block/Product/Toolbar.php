...
class Custom_Designer_Block_Product_Toolbar extends Mage_Catalog_Block_Product_List_Toolbar
{
    ...
    public function getCurrentDirection()
    {
        ...
        return strtolower(Mage::helper('designer')->defaultPostSort(Mage::app()->getStore()->getId()));
    }
