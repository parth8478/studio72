<?php
class Themevast_Opc_Model_Observer{
	...
	/*public function checkRequiredModules($observer){
		...
		if (Mage::getSingleton('admin/session')->isLoggedIn()) {
				...
				if ($cache->load("themevast_opc")===false){
					$message = 'Important: Please setup IWD_ALL in order to finish <strong>Themevast One Page Checkout</strong> installation.<br />
					...
					$cache->save('true', 'themevast_opc', array("themevast_opc"), $lifeTime=5);
				}
