...
$installer->run("-- DROP TABLE IF EXISTS {$this->getTable('smsnotify_register_otp')};
CREATE TABLE {$this->getTable('smsnotify_register_otp')} (
...
$installer->run("-- DROP TABLE IF EXISTS {$this->getTable('smsnotify_report')};
CREATE TABLE {$this->getTable('smsnotify_report')} (
	  `id` int(11) unsigned NOT NULL auto_increment,
